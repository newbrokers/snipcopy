...
"%~dp0IconMaker.exe" "%~dp0website\public\images\products\audio-crop.png" "%~dp0audiocrop-csharp\AudioCrop.ico"
if errorlevel 1 exit /b 1
...
"%DOTNET_EXE%" build "%~dp0audiocrop-csharp\AudioCrop.csproj" -c Release -p:Platform=x64
