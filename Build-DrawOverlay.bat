...
"%~dp0IconMaker.exe" "%~dp0website\public\images\products\draw-overlay.png" "%~dp0draw-overlay-csharp\DrawOverlay.ico"
if errorlevel 1 exit /b 1
...
"%DOTNET_EXE%" build "%~dp0draw-overlay-csharp\DrawOverlay.csproj" -c Release -p:Platform=x64
